        ...
        <div class="row q-col-gutter-sm">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <q-card
                    ...
                    :class="$q.platform.is.desktop ? 'q-mr-sm' : ''"
                >
                    <img
                    ...
                    <q-card-section class="q-pt-xs">
                        ...
                        <div
                            class="text-caption text-center q-mt-sm text-grey-9"
                        >
                            Enter your pincode to check availability and faster
                            options
                        </div>
                        <div class="q-mt-sm">
                            <q-input
                        ...
                        <div class="q-mt-xs">
                            <div style="display: block; height: 22px">
                                <q-btn
                                    size="sm"
                                    label="Save"
                                    class="q-mt-xs text-capitalize bg-primary text-white float-right"
                                />
                            </div>
                        </div>
                    </q-card-section>
            ...
            <div class="row items-center q-mx-sm">
                <div class="col-12 q-mt-sm">
                    <div class="q-pl-md bg-white q-pt-sm">
                        ...
                        >
                        <a class="text-primary q-ml-sm cursor-pointer"
                            >[see all]</a
                        >
                    </div>
                    <q-carousel
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div>Redmi 8</div>
                                    <div
                                        class="text-caption text-weight-bold text-green"
                                    >
                                        5000h mAh Battery
                                    </div>
                                    <div>
