<template>
    <q-layout view="lHh LpR lFf" style="font-family: Lato;"><!-- 
      ...
      <q-header reveal elevated style="background-color: #1f509e;">
        <q-toolbar v-if="!$q.platform.is.desktop" class="q-py-sm">
          <div class="row">
            <div class="col-sm-12 col-xs-12">
              <q-toolbar-title>
                <img @click="$router.push('/home')" class="cursor-pointer float-left" src="../assets/bu_logo(64x64).png" style="width: 12%"/>
                <span class="float-left q-mt-xs q-ml-md text-h6 text-weight-bold" style="font-size: 17px;">E-Commerce</span>
              </q-toolbar-title>
            </div>
        ...
        <q-toolbar v-if="$q.platform.is.desktop" class="q-py-sm">
          <!--          <q-btn @click="left = !left" flat round dense icon="menu" class="q-mr-sm" />-->
          <img @click="$router.push('/home')" class="cursor-pointer" src="../assets/bu_logo(64x64).png" style="width: 3%"/>
          <q-toolbar-title>
            <span class="float-left q-mt-xs text-h6 text-weight-bold" style="font-size: 17px;">E-Commerce</span>
          ...
          <div style="background-color: #163758;">
            <div class="q-mr-md text-right q-py-xs text-weight-bold text-grey-6" style="">
              ...
              <a target="_blank" class="text-blue-1 hover_underline_white" style="text-decoration: none"
                 href="https://butechltd.com">BU Tech</a>.
            </div>
          </div>
        </div>
      </q-page-container>
